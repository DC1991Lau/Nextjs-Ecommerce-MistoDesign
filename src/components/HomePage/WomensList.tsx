...
const WomensList: React.FC = () => {
  return (
    <Container className="mt-6 md:mt-9">
      <div className="flex flex-col md:flex-row items-center justify-between">
        <h3 className="text-h3 mb-4 md:mb-0 font-semibold mr-6">WOMEN'S</h3>
      ...
      <Button type="button" className="bg-grey font-medium">
        <Link href="/women">SEE ALL</Link>
      </Button>
    </Container>
  )
}
